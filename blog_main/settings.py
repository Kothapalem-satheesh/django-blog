...
# # handler404 = 'blogs.views.custom_404'  # Replace 'yourapp' with your app name
...
# STATICFILES_DIRS = [
#     BASE_DIR / 'blog_main/static',  # Your main static files location
# ]
...
ALLOWED_HOSTS = [
    ...
    'localhost',
    '127.0.0.1',
    'kothapalem-satheesh31.vercel.app',  # Your Vercel domain
]
...
MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ADD THIS for Vercel
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
...
# Create a PostgreSQL database on Vercel or use another provider
